...
var roteiroBinicio = dados.split("#Roteiro B", 1).join("#Roteiro B").length;;
var roteiroBfim =dados.split("#Roteiro C", 1).join("#Roteiro C").length;;
var roteiroB = dados.substring(roteiroBinicio,roteiroBfim);
var roteiroBquant = roteiroB .split(";").length;
alert("Número de locais do roteiro B = " + roteiroBquant);
var roteiroBfinal = roteiroB.replaceAll('<br>', '\n')
                        .replaceAll('</b>', ' ')
                        .replaceAll('*', ' ')
                        .replaceAll('<b>', ' ')
                        .replaceAll('#', '\n');
...
var roteiroCinicio = dados.split("#Roteiro C", 1).join("#Roteiro C").length;;
var roteiroCfim = dados.split("<b>->2", 1).join("<b>->2").length;
var roteiroC = dados.substring(roteiroCinicio,roteiroCfim);
var roteiroCquant = roteiroC .split(";").length;
alert("Número de locais do roteiro C = " + roteiroCquant);
var roteiroCfinal = roteiroC.replaceAll('<br>', '\n')
                        .replaceAll('</b>', ' ')
                        .replaceAll('*', ' ')
                        .replaceAll('<b>', ' ')
                        .replaceAll('#', '\n');
...
var roteiroBinicio = dados.split("#Roteiro B", 2).join("#Roteiro B").length;;
var roteiroBfim =dados.split("#Roteiro C", 2).join("#Roteiro C").length;;
var roteiroB = dados.substring(roteiroBinicio,roteiroBfim);
var roteiroBquant = roteiroB .split(";").length;
alert("Número de locais do roteiro B = " + roteiroBquant);
var roteiroBfinal = roteiroB.replaceAll('<br>', '\n')
...
var roteiroCinicio = dados.split("#Roteiro C", 2).join("#Roteiro C").length;;
var roteiroCfim = dados.split("<b>->3", 1).join("<b>->3").length;
var roteiroC = dados.substring(roteiroCinicio,roteiroCfim);
var roteiroCquant = roteiroC .split(";").length;
alert("Número de locais do roteiro C = " + roteiroCquant);
var roteiroCfinal = roteiroC.replaceAll('<br>', '\n')
...
var roteiroBinicio = dados.split("#Roteiro B", 3).join("#Roteiro B").length;;
var roteiroBfim =dados.split("#Roteiro C", 3).join("#Roteiro C").length;;
var roteiroB = dados.substring(roteiroBinicio,roteiroBfim);
var roteiroBquant = roteiroB .split(";").length;
alert("Número de locais do roteiro B = " + roteiroBquant);
var roteiroBfinal = roteiroB.replaceAll('<br>', '\n')
...
var roteiroCinicio = dados.split("#Roteiro C", 3).join("#Roteiro C").length;;
var roteiroCfim = dados.split("<br></body>", 1).join("<br></body>").length;
var roteiroC = dados.substring(roteiroCinicio,roteiroCfim);
var roteiroCquant = roteiroC .split(";").length;
alert("Número de locais do roteiro C = " + roteiroCquant);
var roteiroCfinal = roteiroC.replaceAll('<br>', '\n')
